...
export function ExcursionTerminee(props: ExcursionTermineeProps) {
  ...
  return (
    <Modal animationType="slide" transparent={true} visible={modalExcursionTermineeVisible}>
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          <Text
            style={styles.modalTitle}
            tx="detailsExcursion.popup.excursionTerminee.felicitations"
            size="xl"
            weight="bold"
          />
          <Text
            style={styles.modalText}
            tx="detailsExcursion.popup.excursionTerminee.message"
            size="lg"
          />
          <View style={styles.containerBouton}>
            ...
            >
              <Text
                ...
                tx="detailsExcursion.popup.excursionTerminee.fermer"
                size="sm"
              />
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Text
                style={styles.textStyle}
                tx="detailsExcursion.popup.excursionTerminee.accueil"
                size="sm"
              />
            </TouchableOpacity>
          </View>
